    ...
    <div className="space-y-16">
      ...
      <section className="space-y-5">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.25em] text-orange-300">Fresh from MongoDB</p>
            <h2 className="text-2xl font-bold sm:text-3xl">Live game entries</h2>
          </div>
          <p className="max-w-md text-sm text-zinc-400">Every card is loaded from the database. Open the game wiki entry or launch the deployed build directly.</p>
        </div>
